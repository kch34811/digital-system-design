...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports LED_GREEN_1]					
	set_property IOSTANDARD LVCMOS33 [get_ports LED_GREEN_1]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports LED_GREEN_2]					
	set_property IOSTANDARD LVCMOS33 [get_ports LED_GREEN_2]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports LED_GREEN_3]					
	set_property IOSTANDARD LVCMOS33 [get_ports LED_GREEN_3]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports LED_GREEN_4]					
	set_property IOSTANDARD LVCMOS33 [get_ports LED_GREEN_4]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports LED_WHITE]					
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports LED_RED_1]					
	set_property IOSTANDARD LVCMOS33 [get_ports LED_RED_1]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports LED_RED_2]					
